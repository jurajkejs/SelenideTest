...
public class SavingsCalculatorPage {
    ...
    //public void enterEmail(String email) {$(emailInput).val(email).pressTab();
    public void enterEmail(String email) {
        emailInput.val(email).pressTab();
    }

    //public void enterYears(int years) {$(yearsInput).val(String.valueOf(years));
    public void enterYears(int years) {
        yearsInput.val(String.valueOf(years));
    }
    //public void enterOneTimeInvestment(String amount) { $(oneTimeInvestmentInput).val(amount);
    public void enterOneTimeInvestment(String amount) {
        oneTimeInvestmentInput.val(amount);
    }
    //public void selectFund(String fundToSelect) { $(fundSelect).selectOption(fundToSelect);
